...
int main (){
    ...
    piece piecesBoard[TAILLEPPIECEECHECS]={pion1,pion2,bishop1,bishop2,knight1,knight2,rook1,rook2,prince1,prince2,centaur1,centaur2,michelVaillant1,michelVaillant2,queen1,queen2,archer1,archer2,king1,king2};
